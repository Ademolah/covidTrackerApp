package com.pyramid.covidTrackerApp.services;

import com.pyramid.covidTrackerApp.models.LocationStats;
...
public class CovidDataService {
    ...
    @PostConstruct
    @Scheduled(cron = "* * 1 * * *")  //scheduling to run the fetchVirusData every seconds
